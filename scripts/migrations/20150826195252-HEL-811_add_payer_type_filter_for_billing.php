 ...
 * @author
 */
class MigrationClass_20150826195252 extends SchemaChange
{
...
this:BEGIN
    ...
    SET @query_sql := CONCAT("
        SELECT SQL_CALC_FOUND_ROWS
			...
			INNER JOIN tblEncounterPayer EP ON EP.encounter_id = E.encounter_id AND EP.is_deleted = 0
			INNER JOIN tblPayer PY ON EP.payer_id = PY.payer_id AND PY.is_deleted = 0 AND PY.coverage_order = 1
			INNER JOIN tblPayerCompany PC ON PC.payer_company_id = PY.payer_company_id
 			INNER JOIN tblPayerType PT ON PT.payer_type_id = PC.payer_type_id
