 ...
 * @author
 */
class MigrationClass_20150323193243 extends SchemaChange
{
...
this:BEGIN
	...
	FROM
		tblSample T
		INNER JOIN tblSampleBatch SB ON T.sample_id = SB.sample_id
		INNER JOIN tblUser U ON T.created_by = U.user_id
		...
		INNER JOIN tblDoctor D ON E.doctor_id = D.doctor_id
		INNER JOIN tblContact D_C ON D.contact_id = D_C.contact_id
		INNER JOIN tblSampleStatus SS ON T.sample_status_id = SS.sample_status_id
	WHERE
		SB.batch_id = s_batch_id
		AND
		SB.is_deleted = 0
