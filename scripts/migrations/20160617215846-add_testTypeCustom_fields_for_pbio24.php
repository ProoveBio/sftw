 ...
 * @author
 */
class MigrationClass_20160617215846 extends SchemaChange
{
...
UPDATE `tblTestType` SET test_type_name = 'Proove Drug Metabolism Psychiatric' WHERE external_test_type_id = 'PBIO2B';

UPDATE `tblTestType` SET is_active = 1 WHERE external_test_type_id IN ('PBIO22','PBIO24','PBIO25');
...
UPDATE `tblTestType` SET test_type_name = 'Proove Drug Metabolism Psychotropics' WHERE external_test_type_id = 'PBIO2B';

UPDATE `tblTestType` SET is_active = 0 WHERE external_test_type_id IN ('PBIO22','PBIO24','PBIO25');
