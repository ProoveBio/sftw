 ...
 * @author
 */
class MigrationClass_20160725183047 extends SchemaChange
{
...
UPDATE `tblTestType` SET is_active = 0 WHERE external_test_type_id IN ('PBIO2A','PBIO2B','PBIO2C');
...
(44,5,'Pain','pain','checkbox',1),
(45,5,'Psychiatric','psych','checkbox',2),
(46,5,'Cardiovascular','cardio','checkbox',3);
...
UPDATE `tblTestType` SET is_active = 1 WHERE external_test_type_id IN ('PBIO2A','PBIO2B','PBIO2C');
