 ...
 * @author
 */
class MigrationClass_20161004192902 extends SchemaChange
{
...
this:BEGIN
	...
	SET @query_sql := CONCAT("
		...
		FROM
			...
			INNER JOIN tblAccountContact OTHER_AC ON OTHER_AC.account_id = T.account_id AND OTHER_AC.is_deleted = 0
