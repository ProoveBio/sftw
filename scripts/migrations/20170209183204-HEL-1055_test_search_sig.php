 ...
 * @author
 */
class MigrationClass_20170209183204 extends SchemaChange
{
...
this:BEGIN
    ...
    SET @query_sql := CONCAT("
        SELECT SQL_CALC_FOUND_ROWS
            ...
            INNER JOIN tblAccount CORP_A ON A.parent_id = CORP_A.account_id
            INNER JOIN tblContact A_C ON CORP_A.contact_id = A_C.contact_id AND A_C.is_deleted = 0
