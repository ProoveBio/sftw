 ...
 * @author
 */
class MigrationClass_20150713235807 extends SchemaChange
{

	public function up()
	{
	    $indexes = <<< INDEXES
ALTER TABLE `tblSample` ADD INDEX `external_sample_id` (`external_sample_id`);
ALTER TABLE `tblSample` ADD INDEX `created_by` (`created_by`);
ALTER TABLE `tblEncounter` ADD INDEX `created_datetime` (`created_datetime`);
ALTER TABLE `tblContact` ADD INDEX `company_name` (`company_name`);
ALTER TABLE `tblAccount` ADD INDEX `sf_ra_user_id` (`sf_ra_user_id`);
ALTER TABLE `tblUser` ADD INDEX `sf_user_id` (`sf_user_id`);
INDEXES;
	    $this->querySQL($indexes);
...
EOT;
	...
	{
	    $indexes = <<< INDEXES
ALTER TABLE `tblSample` DROP INDEX `external_sample_id`;
ALTER TABLE `tblSample` DROP INDEX `created_by`;
ALTER TABLE `tblEncounter` DROP INDEX `created_datetime`;
ALTER TABLE `tblContact` DROP INDEX `company_name`;
ALTER TABLE `tblAccount` DROP INDEX `sf_ra_user_id`;
ALTER TABLE `tblUser` DROP INDEX `sf_user_id`;
INDEXES;
	    $this->querySQL($indexes);
